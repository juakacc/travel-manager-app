...
class Home extends React.Component {
    ...
    loadViagem = async () => {
        ...
        await axios.get(`viagens/atual/${this.props.motorista.id}`)
        .then(res => {
            if (this._isMounted) {
                this.setState({ 
                    viagem: res.data,
        ...
        return (
            <PTRView onRefresh={this.loadViagem}>
                <View style={styles.container}>
                    ...
                    <Text style={styles.textoAviso}>Puxe <Icon name='arrow-down' /> para atualizar os veículos disponíveis</Text>
